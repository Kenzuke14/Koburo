    ...
    return (
        <>
            ...
            {!data.loading && blockchain.smartContract !== null ? (
                    <button
                        className={
                            (data.paused ? 'bg-gray-300' : 'bg-white hover:bg-gray-300') +
                            ' text-2xl px-28 py-2 rounded-xl  border-4 border-black text-black transition-all duration-200 ease-in-out'
                        }
                        onClick={(e) => {
                            claimNFTs()
                        }}
                ...
                {blockchain.account === '' || blockchain.smartContract === null ? (
                    <button
                        className="text-2xl px-28 py-2 rounded-xl font-vt323 text-white bg-black border-4 border-black hover:bg-white hover:border-black-800 hover:text-black transition-all duration-200 ease-in-out"
                        onClick={(e) => {
                            e.preventDefault()
                            dispatch(connect())
                            getData()
